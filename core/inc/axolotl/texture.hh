...
namespace axl {
  ...
  struct TextureCube {
    TextureCube(const std::filesystem::path &path = "", TextureType type = TextureType::Last, const TextureData &data = { });
  ...
  class TextureStore {
   public:
    ...
    static void RegisterTexture(Texture2D &texture, const std::filesystem::path &path, TextureType type, const TextureData &data);
    static void RegisterTexture(TextureCube &texture, const std::filesystem::path &path, TextureType type, const TextureData &data);
